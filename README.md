Assignment (Main CSS Project): So for this one, you will have to create a responsive website
that is 3-5 pages long (including the landing page). As your client, I have provided you with some
